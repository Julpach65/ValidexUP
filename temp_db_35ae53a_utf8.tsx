    ...
    return (
        <div className="bg-[#0f172a] min-h-screen font-sans text-slate-200">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
                <div className="mb-12">
                    <h1 className="text-3xl font-bold text-white mb-2">Centro de Control T├íctico</h1>
                    <p className="text-slate-400">Seleccione el m├│dulo operativo para continuar.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold text-white mb-3 z-10">Gesti├│n de Pipas y Descargas</h2>
                        <p className="text-slate-400 text-center text-sm max-w-xs z-10 leading-relaxed group-hover:text-slate-300 transition-colors">
                            Autorizaci├│n biom├®trica para descarga de tanques, monitoreo de volumen y asignaci├│n.
                        </p>
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold text-white mb-3 z-10">Bit├ícora y Auditor├¡a</h2>
                        <p className="text-slate-400 text-center text-sm max-w-xs z-10 leading-relaxed group-hover:text-slate-300 transition-colors">
            ...
            <footer className="w-full py-6 text-center border-t border-slate-800 mt-auto bg-slate-900/50">
                <p className="text-xs text-slate-500 font-medium tracking-wide">
                    SISTEMA DE AUTORIZACI├ôN ZERO-TRUST ÔÇó VERSI├ôN DE PRODUCCI├ôN
                </p>
            </footer>
        </div>
    );
