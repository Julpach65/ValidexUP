                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        {[
                            ...
                            <div key={item.label} className="glass-card bg-[#151e32]/80 border-white/5 p-6 flex items-center gap-5 group hover:border-emerald-500/20 transition-all rounded-2xl">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-6">
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <button
                                ...
                                className="flex-1 py-5 bg-emerald-500 hover:bg-emerald-400 text-white font-black rounded-2xl shadow-[0_0_25px_rgba(16,185,129,0.3)] border border-emerald-400 transition-all flex items-center justify-center gap-3 uppercase tracking-widest text-[11px]"
                            >
