...
export default function OnboardingSidebar() {
  const features = [
    { icon: 'lock', title: 'Cifrado de extremo a extremo', desc: 'Tus datos están protegidos con AES-256.' },
    { icon: 'verified_user', title: 'Sistema Zero-Trust', desc: 'Validación robusta con múltiples factores.' },
